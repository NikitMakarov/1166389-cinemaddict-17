...
import StatisticsPresenter from './presenter/footer-statistics-presenter.js';
...
const statisticsPresenter = new StatisticsPresenter(filmsModel, siteFooterElement);
